...
const AllRooms = () => {
  ...
  // Dummy options (replace with real data if needed)
  const roomTypes = ["Deluxe", "Suite", "Standard"];
  const priceRanges = ["100-200", "201-300", "301-400"];
  ...
  // Handlers
  const handleRoomChange = (checked, label) => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
          ...
          <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <p className='text-xl font-medium text-grey-700'>
                ${room.pricePerNight}
                <span className='text-xs font-medium text-gray-500 tracking-wide font-inter'> /night</span>
              </p>
            </div>
          </div>
        ))}
      ...
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
        ...
        <div className={`${openfilters ? "h-auto" : "h-0 lg:h-auto"} overflow-hidden transition-all duration-700 mb-5`}>
